...
function SWEP:GetViewModelPosition(pos, ang)
    ...
    ang:RotateAroundAxis(oldang:Right(), actual.evang.x - (self:GetGunPunchPitch()*1.5))
    ang:RotateAroundAxis(oldang:Up(), actual.evang.y + (self:GetGunPunchYaw()*1.5))
    ...
    pos = pos + ( actual.pos.x - ( self:GetGunPunchYaw() * 0.1 * Lerp( self:GetSightDelta(), 0, 1 ) ) ) * ang:Right()
    pos = pos + ( actual.pos.y + ( self:GetGunPunchPitch() * 0.5 ) ) * ang:Forward() * Lerp( self:GetSightDelta(), 0.5, 1 )
